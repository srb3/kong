...
local function load_proto(filename, data)
  assert(protoc:load(data, filename))
end

-- parse & load proto files globally on module loading
-- https://github.com/open-telemetry/opentelemetry-proto/blob/v0.18.0/opentelemetry/proto/common/v1/common.proto
load_proto("opentelemetry/proto/common/v1/common.proto", [[
  syntax = "proto3";
...
load_proto("opentelemetry/proto/resource/v1/resource.proto", [[
  syntax = "proto3";
...
load_proto("opentelemetry/proto/trace/v1/trace.proto", [[
  syntax = "proto3";
...
load_proto("collector/trace/v1/trace_service.proto", [[
  syntax = "proto3";
